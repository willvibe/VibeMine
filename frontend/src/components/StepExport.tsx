...
export default function StepExport() {
  ...
  const MODEL_NAMES_MAP: Record<string, string> = {
    ...
    en: 'Elastic Net',
    rf: taskType === 'regression' ? 'Random Forest Regressor' : 'Random Forest',
    et: taskType === 'regression' ? 'Extra Trees Regressor' : 'Extra Trees Classifier',
    gbc: 'Gradient Boosting Classifier',
    gbr: 'Gradient Boosting Regressor',
    xgb: 'XGBoost',
    lightgbm: taskType === 'regression' ? 'LightGBM Regressor' : 'LightGBM',
    dt: taskType === 'regression' ? 'Decision Tree Regressor' : 'Decision Tree',
    knn: taskType === 'regression' ? 'K-Nearest Neighbors Regressor' : 'K-Nearest Neighbors',
    ada: 'AdaBoost',
